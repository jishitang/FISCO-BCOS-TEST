...
.. admonition:: 概览
    ...
    - 测试方案基于FISCO BCOS 2.0系列版本展开

.. admonition:: 方针

    - 任何一个平台在发布使用前，都必须经过严格、周密的测试，尽可能做到在测试环境覆盖实际生产环境所有可能的场景，有条件的可以直接在生产环境上进行稳定性测试。

.. important:: 目标
   
   - 面向基于FISCO BCOS为底层平台的应用，完成质量管理中涉及到的测试框架内容，能保证业务线上的稳定运行。
