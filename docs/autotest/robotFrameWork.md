...
|@{g1_ip_list}  |172.xx.xxx.21,${su_user},${su_pwd},${port}    172.xx.xxx.21,${su_user},${su_pwd},${port}  <br/>  172.xx.xxx.29,${su_user},${su_pwd},${port}    172.xx.xxx.20,${su_user},${su_pwd},${port}  <br/>  172.xx.xxx.20,${su_user},${su_pwd},${port}    172.xx.xxx.20,${su_user},${su_pwd},${port}  <br/>  172.xx.xxx.45,${su_user},${su_pwd},${port}   |g1群组各节点所在服务器，按环境组网中A/B/C/D/E/F/G顺序填写|
