...
+ 节点间可以内外网混合模式。<br/><br/>
+ 节点间网络不通，可通过第三个节点转发（如4节点环境，A/B节点网络不通）。<br/><br/>
+ ？？？？
+ 
...
+ 节点进程状态异常，如挂起状态等（可通过kill -STOP PID触发，kill -CONT PID命令恢复；也可通过一些故障工具模拟）。挂起后，进程由S变为T状态，节点没有时间片运行代码，不能正常处理业务。<br/><br/>
+ 节点证书有误。<br/><br/>
